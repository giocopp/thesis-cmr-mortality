...
add("\\begin{table}[H]")
add("\\centering")
add("\\caption{Data and analytical sample. Central Mediterranean route, 2014--2023.}")
...
add("Notes: Mortality numbers use the analytical filters (analysis polygon; drowning, mixed, or unknown causes; IOM excludes split incidents).")
add("\\end{minipage}")
add("\\end{table}")
