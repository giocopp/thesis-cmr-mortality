...
# Output: output/tables/diag_swh_grid_corr.txt
#         output/figures/diag_swh_grid_corr_hist.png
#         output/figures/diag_swh_grid_corr_map.png
...
cat("============================================================\n")
cat("diag_swh_grid_corr: spatial homogeneity of SWH in core corridor\n")
cat("============================================================\n\n")
...
# ── 7. Write table ─────────────────────────────────────────
sink_file <- file.path(BASE_DIR, "output", "tables", "diag_swh_grid_corr.txt")
sink(sink_file)
...
fig_hist <- file.path(BASE_DIR, "output", "figures",
                       "diag_swh_grid_corr_hist.png")
...
fig_panel <- file.path(BASE_DIR, "output", "figures",
                        "diag_swh_grid_corr_panel.png")
