...
saveRDS(all_res, file.path(BASE_DIR, "output", "tables", "22_rolling_beta.RDS"))
...
sink_file <- file.path(BASE_DIR, "output", "tables", "22_rolling_beta.txt")
sink(sink_file)
...
fig_path <- file.path(BASE_DIR, "output", "figures", "22_rolling_beta.png")
ggsave(fig_path, combined_plot, width = 10, height = 8, dpi = 200)
cat(sprintf("Saved: %s\n", fig_path))
