...
build_crossings_figure(
  ...
  output_path = file.path(BASE_DIR, "output", "figures", "desc_panel_crossings_iom.png"),
  shared_sf = deaths_sf
)
...
build_crossings_figure(
  ...
  output_path = file.path(BASE_DIR, "output", "figures", "desc_panel_crossings_united.png"),
  shared_sf = deaths_sf
)
...
ggsave(
  file.path(BASE_DIR, "output", "figures", "desc_panel_event_type.png"),
