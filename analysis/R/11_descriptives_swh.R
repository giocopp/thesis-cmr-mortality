...
ggsave(file.path(BASE_DIR, "output", "figures",
                  "11_descriptives_swh_heatmap.png"),
       p_heat, width = 11, height = 9, dpi = 200)
cat("Saved: output/figures/11_descriptives_swh_heatmap.png\n")
...
ggsave(file.path(BASE_DIR, "output", "figures",
                  "11_descriptives_swh_centre_of_mass.png"),
       p_com, width = 10, height = 6, dpi = 200)
cat("Saved: output/figures/11_descriptives_swh_centre_of_mass.png\n")
...
if (requireNamespace("patchwork", quietly = TRUE)) {
  ...
  ggsave(file.path(BASE_DIR, "output", "figures",
                    "11_descriptives_swh_pr_deadly_day.png"),
...
cat("Saved: output/figures/11_descriptives_swh_pr_deadly_day.png\n")

# ── 8. Save text output ────────────────────────────────────
sink_file <- file.path(BASE_DIR, "output", "tables", "11_descriptives_swh.txt")
sink(sink_file)
