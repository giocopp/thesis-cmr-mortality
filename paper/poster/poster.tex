...
\definecolor{bg}{HTML}{36454F}
\definecolor{panel}{HTML}{4A5B66}
\definecolor{darkcell}{HTML}{2C3A44}
...
\begin{minipage}[c]{0.80\textwidth}
  ...
  \vspace{5.5mm}
  {\color{muted}\fontsize{32pt}{38pt}\selectfont
   \textbf{Migrant mortality and the 2017 Italy--Libya MoU on the Central Mediterranean Route}\par}
  \vspace{6.5mm}
  {\color{ink}\fontsize{22pt}{26pt}\selectfont
   \textbf{Giorgio Coppola -- MSc of Data Science for Public Policy}, Hertie School
...
\begin{minipage}[t]{\col}
  ...
  \begin{whitecard}\includegraphics[width=\linewidth]{fig-policy-timeline.png}\end{whitecard}
  ...
  \begin{whitecard}\includegraphics[width=\linewidth]{fig-sea-zones-united-sar-panel.png}\end{whitecard}
...
\begin{minipage}[t]{\col}
  ...
  \begin{whitecard}\includegraphics[width=\linewidth]{fig-crossings-ad.png}\end{whitecard}
